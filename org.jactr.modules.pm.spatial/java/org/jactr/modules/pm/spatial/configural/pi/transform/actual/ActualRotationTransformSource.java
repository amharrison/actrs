...
public class ActualRotationTransformSource extends
    AbstractActualTransformSource implements ITransformSource
{
  /**
   * logger definition
   */
  static public final Log LOGGER = LogFactory
                                     .getLog(ActualRotationTransformSource.class);

  /**
   * @param rotationAmount
   *            how much to transform
   * @param rate
   *            how fast we can imagine this transform
   */
  public ActualRotationTransformSource(IConfiguralModule module,
      double[] rotationAmount, double[] rate, double startTime)
  {
