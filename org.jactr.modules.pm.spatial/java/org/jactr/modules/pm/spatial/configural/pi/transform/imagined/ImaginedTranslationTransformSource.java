...
public class ImaginedTranslationTransformSource extends
    AbstractImaginedTransformSource
{
  /**
   logger definition
   */
  static public final Log LOGGER = LogFactory
                                     .getLog(ImaginedTranslationTransformSource.class);
   ...
   * @param startTime
   */
  public ImaginedTranslationTransformSource(IConfiguralModule module, double[] amount, double[] rate,
      double startTime)
  {
