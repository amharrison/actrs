...
import org.jactr.modules.pm.spatial.configural.IConfiguralComparisonTimeEquation;
import org.jactr.modules.pm.spatial.configural.IConfiguralModule;
public class DefaultConfiguralComparisonTimeEquation implements
    IConfiguralComparisonTimeEquation
{
  /**
   logger definition
   */
  static public final Log LOGGER = LogFactory
                                     .getLog(DefaultConfiguralComparisonTimeEquation.class);

  public double computeComparisonTime(IChunk comparison,
